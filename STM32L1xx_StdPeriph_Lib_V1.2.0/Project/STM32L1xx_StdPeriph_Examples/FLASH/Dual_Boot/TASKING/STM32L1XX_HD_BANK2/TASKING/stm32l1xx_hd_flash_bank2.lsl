...
#  define __VECTOR_TABLE_ROM_ADDR       0x08030000
#endif
...
#ifndef __FLASH_SIZE
#  define __FLASH_SIZE  192k
#endif
#ifndef __SRAM_SIZE
#  define __SRAM_SIZE   48k
#endif
#ifndef __EEPROM_SIZE
#  define __EEPROM_SIZE 12k
#endif
...
memory STM32L1xx_Flash
{
    ...
    type = rom;
    size = 192K;
    map ( size = 192K, dest_offset=0x08030000, dest=bus:ARM:local_bus);
}
...
memory STM32L1xx_SRAM
{
    ...
    type = ram;
    size = 44k;
    map ( size = 44k, dest_offset=0x20000000, dest=bus:ARM:local_bus);
}
