...
uint32_t ram_Doze_massive[doze_length]; // 1 ячейка = 10 минут, на протяжении суток
uint32_t ram_max_fon_massive[doze_length]; // 1 ячейка = 10 минут, на протяжении суток
